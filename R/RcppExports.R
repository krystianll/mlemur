...
rluria_list <- function(n = 10L, rate = 1e-8, N0 = 1, Nt = 1e9, mut_fit = 1.0, type = 0L, wt_dp = 0, mut_dp = 0, lag = 0, e = 1, cv = 0, trim = 0L) {
    .Call(`_mlemur_rluria_list`, n, rate, N0, Nt, mut_fit, type, wt_dp, mut_dp, lag, e, cv, trim)
}

rluria_vec <- function(n = 10L, rate = 1e-8, N0 = 1, Nt = 1e9, mut_fit = 1.0, type = 0L, wt_dp = 0, mut_dp = 0, lag = 0, e = 1, cv = 0, trim = 0L) {
    .Call(`_mlemur_rluria_vec`, n, rate, N0, Nt, mut_fit, type, wt_dp, mut_dp, lag, e, cv, trim)
}
